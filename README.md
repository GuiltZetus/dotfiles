...
## pacman:
```
nvim hyprland rofi fcitx5 fcitx5-configtool fcitx5-chinese-addons ncsway brightnessctl hyprsunset wl-clipboard
```
## yay:
```
oh-my-posh fcitx5-bamboo python-mutagen hyprshot mirage
```
